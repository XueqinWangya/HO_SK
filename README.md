...
The folders Hyperedge Overlap and Real network are used to generate the network structure, and HO-SK is used for numerical simulation calculations.

Part of the code in this repository is adapted from (https://github.com/santiagolaot/hyperedge-overlap?tab=readme-ov-file), and has been modified for the purposes of this project.
